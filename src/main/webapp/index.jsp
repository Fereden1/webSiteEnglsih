  ...
  <main>
    ...
    <section class="about-courses" id="courses">
      <div class="container">
        ...
        <!-- Фильтр курсов (изначально скрыт) -->
        ...
        <!-- Контент курса (изначально скрыт) -->
            ...
            <form id="applicationForm" onsubmit="submitApplication(event)">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea id="userMessage" name="message" rows="4" 
                         placeholder="Расскажите о ваших целях в изучении английского..."></textarea>
              </div>
